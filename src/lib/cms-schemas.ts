...
export const SECTION_SCHEMAS: Record<string, SectionSchema> = {
  ...
  HeroSection: {
    fields: [
      ...
      { key: "ctaPrimary", label: "CTA Button – Label", type: "text" },
      { key: "ctaPrimaryLink", label: "CTA Button – Link (leave blank = opens donation modal)", type: "link" },
      { key: "ctaSecondary", label: "Scroll Link – Label", type: "text" },
      { key: "ctaSecondaryLink", label: "Scroll Link – Destination", type: "link" },
      { key: "statName", label: "Bubble – Name (Line 1)", type: "text" },
      { key: "stat1", label: "Bubble – Line 2", type: "text" },
      { key: "stat2", label: "Bubble – Line 3", type: "text" },
      { key: "stat3", label: "Bubble – Line 4", type: "text" },
    ...
    defaultContent: {
      ...
      ctaSecondaryLink: "anchor:section4-awards",
      statName: "Ujjwala Wadekar",
      stat1: "31 yrs",
  ...
  HonestImpactSection: {
    fields: [
      ...
      { key: "photo1",  label: "Photo 1 (top-left large)",      type: "image" },
      { key: "photo2",  label: "Photo 2 (tall center)",         type: "image" },
      { key: "photo3",  label: "Photo 3 (top stacked)",         type: "image" },
      { key: "photo4",  label: "Photo 4 (bottom stacked)",      type: "image" },
      { key: "photo5",  label: "Photo 5 (bottom right of card)", type: "image" },
      { key: "photo6",  label: "Photo 6 (top stacked)",         type: "image" },
      { key: "photo7",  label: "Photo 7 (bottom stacked)",      type: "image" },
      { key: "photo8",  label: "Photo 8 (top of card)",         type: "image" },
      { key: "photo9",  label: "Photo 9 (tall center 2)",       type: "image" },
      { key: "photo10", label: "Photo 10 (top stacked)",        type: "image" },
      { key: "photo11", label: "Photo 11 (bottom stacked)",     type: "image" },
      { key: "photo12", label: "Photo 12 (bottom right)",       type: "image" },
      { key: "photo13", label: "Photo 13 (top stacked)",        type: "image" },
      { key: "photo14", label: "Photo 14 (bottom stacked)",     type: "image" },
    ],
    isCarousel: true,
  ...
  WhatProgressSection: {
    ...
    itemFields: [
      ...
      { key: "video", label: "Video URL (plays on click)", type: "video" },
    ],
    defaultItems: [
