...
const SECTIONS_BY_PAGE: Record<string, { component_name: string; display_name: string }[]> = {
  home: [
    ...
    { component_name: "S3CarouselSection", display_name: "Media Carousel" },
    { component_name: "RecognitionsSection", display_name: "Recognitions / Awards" },
    { component_name: "BeyondSyllabusSection", display_name: "Beyond Syllabus Accordion" },
    ...
    { component_name: "IntroNGOSection", display_name: "Intro — Vision & Mission" },
    { component_name: "ProgramsSection", display_name: "Programs" },
    { component_name: "GetInvolvedSection", display_name: "Get Involved" },
    { component_name: "ProcessFlowSection", display_name: "Process Flow" },
    { component_name: "HonestImpactSection", display_name: "Honest Impact Cards" },
    { component_name: "SupportCTASection", display_name: "Support CTA Banner" },
